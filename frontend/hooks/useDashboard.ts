...
import { campaignServiceClient, analyticsServiceClient, type ApiResponse } from "@/lib/api/client"
...
export function useDashboardAnalytics(
  ...
  const fetchAnalytics = async () => {
    try {
      ...
      // Use analyticsServiceClient for analytics
      const response: ApiResponse<DashboardAnalytics> = await analyticsServiceClient.get(
...
// Hook for campaigns (remains using campaignServiceClient)
export function useCampaigns(
  ...
  const fetchCampaigns = async () => {
    try {
      ...
      // Use campaignServiceClient for campaigns
