...
async def get_campaign_analytics(
    ...
    user_deliverables = db.query(Deliverable).filter(
    ...
    all_deliverables = db.query(Deliverable).filter(
        Deliverable.campaign_id == campaign_id,
    ...
    total_creators = db.query(CampaignApplication).filter(
        CampaignApplication.campaign_id == campaign_id,
        CampaignApplication.status == "approved"
    ).count()
